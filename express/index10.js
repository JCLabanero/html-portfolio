...
app.get("/jokes/:id",(req,res) => {
    ...
    const filteredJoke = jokes.find((joke)=> joke.id === id );
    console.log(`${filteredJoke}, ${id}`);
    res.json(filteredJoke)
});
//get a joke by filtering on the joke type
...
app.post("/jokes",(req,res) => {
    ...
    // const jokeText = req.params.text;
    // const jokeId = jokes[-1].id + 1;
...
app.put("/jokes/:id",(req,res) => {
    ...
    console.log(`${jokes.find((e) => e.id === id)}`);
    res.json(jokes);
});
// patch a joke
app.patch("/jokes/:id",(req,res) => {
    const id = parseInt(req.params.id);
    const existJoke = jokes.find((e)=>e.id === id);
    const patchJoke = {
        id: id,
        jokeText: req.body.text || existJoke.jokeText,
        jokeType: req.body.type || existJoke.jokeType,
    }
    jokes[jokes.findIndex((joke)=>joke.id === id)] = patchJoke;
    console.log(`${jokes[jokes.findIndex((joke)=>joke.id === id)]}`);
    res.json(patchJoke);
});
//delete specific joke
app.delete("/jokes/:id",(req,res) => {
    const id = parseInt(req.params.id);
    // jokes.splice(jokes.findIndex((joke)=>joke.id === id), 1);
